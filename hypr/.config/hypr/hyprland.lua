...
hl.config({
	...
	gaps_in  = 5,
        ...
        resize_on_border = false, -- We use SUPER + RMB
        allow_tearing = false,
    },
...
-- No gaps when there is only one window
...
hl.window_rule({name = "clipse", match = {title="clipse"}, float = true})

-- Screenshots (grim, slurp, swappy)
hl.bind("Print", hl.dsp.exec_cmd("grim -g \"$(slurp)\" - | swappy -f -"))

-- Magnifiyer
hl.bind(mainMod .. " + mouse:274", hl.dsp.exec_cmd(magnifier))
